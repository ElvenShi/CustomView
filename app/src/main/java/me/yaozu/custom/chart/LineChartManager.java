...
public class LineChartManager {
     ...
     * 展示折线图(一条)
     *
     * @param xAxisValues x坐标值
     * @param yAxisValues y 坐标值
     * @param label 折线名称
     * @param color 颜色
     */
     ...
     * @param colours
     */
    public void showMultiLineChart(List<Float> xAxisValues, List<List<Float>> yAxisValues, List<String> labels, List<Integer> colours) {
        initLineChart();
        ArrayList<ILineDataSet> dataSets = new ArrayList<>();
